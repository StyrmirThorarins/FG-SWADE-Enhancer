...
function updateHealthBarScale(tokenCT, nPercentWounded)
	...
	if widgetHealthBar then			
		...
		-- FG Classic
		if OptionsManager.getOption('CE_HHBS') == "option_fgc" then
		...
		-- FG Unity, centered
		if OptionsManager.getOption('CE_HHBS') == "option_fgu_c" then
		...
		-- FG Unity, left aligned
		if OptionsManager.getOption('CE_HHBS') == "option_fgu_l" then
			-- add code
		end
	end
end
...
function drawLargerHealthDot(tokenCT, widgetHealthDot, bVisible)
	...
	-- FG Classic
	if OptionsManager.getOption('CE_LHDS') == "option_fgc" then
	...
	-- FG Unity
	if OptionsManager.getOption('CE_LHDS') == "option_fgu" then
